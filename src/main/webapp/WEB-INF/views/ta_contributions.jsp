 ...
 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <input type="hidden" name="ajax_refresh" class="btn btn-primary" value="No New Message" onclick="window.location.href='/projectcs744/view_ta_contributions?threadId=${threadId}'"/>
                </div>
                <div>		
