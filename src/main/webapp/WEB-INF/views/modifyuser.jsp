...
<!--                     </li> -->
        ...
        <div id="page-wrapper">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input name="firstName" id="firstname" type="text" class="form-control" value ="${user.firstName}" required/>
				</div>
			</div>	
			<div class="form-group">
				<label for="lname" class="col-sm-2 control-label">Last Name *</label>
				<div class="col-sm-6">
					<input name="lastName" id="lastname" type="text" class="form-control" value ="${user.lastName}" required/>
				</div>
			</div>					
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input name="email" id="emailInput" type="email" class="form-control" value ="${user.email}" required/>
				</div>
			</div>	
			<div class="form-group">		
 			...
 			<div class="form-group">
				...
				<a href="<c:url value="/viewusers"/>" ><input type="button" value="Cancel" class="btn btn-primary"></a>
				</div>
			</div>			 				
			</form>
